 ...
 * ```
 */
export declare class Webengage extends AwesomeCordovaNativePlugin {
    /**
 ...
 * @hidden
 */
export declare class WebengageUser extends AwesomeCordovaNativePlugin {
    /**
     * Logs user in
     * @param {string} userId
     * @returns {Promise<any>}
 ...
 * @hidden
 */
export declare class WebengageJwtManager extends AwesomeCordovaNativePlugin {
    /**
 ...
 * @hidden
 */
export declare class WebengagePush extends AwesomeCordovaNativePlugin {
    /**
 ...
 * @hidden
 */
export declare class WebengageNotification extends AwesomeCordovaNativePlugin {
    /**
